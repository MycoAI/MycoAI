...
train = TensorData(filepath='/data1/s2592800/trainset_4merspectrum.pt')
valid = TensorData(filepath='/data1/s2592800/trainset_4merspectrum_valid.pt')
...
for arch in ['CNN-ResNet9', 'CNN-ResNet18']: # 'CNN-Vu', 'CNN-Vu-NoBN'

    name = f'MycoAI-{output}-{arch}-{smoothing}'
    ...
    try:
        ...
        if arch == 'CNN-Vu-NoBN':
            ...
            arch = ResNet([2,2,2,2], in_channels=1)
            fcn_layers = [256]
